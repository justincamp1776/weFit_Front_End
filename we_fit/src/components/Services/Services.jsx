...
const Services = () => {
    return (  
        <Grid justifyContent="center" container spacing={10}>
            ...
            <Grid justifyContent="center" container spacing={10}style ={{marginTop: "50px"}}>
                <Grid item xs={3} />
                <Grid style={{color: "white", marginTop: "50px"}} item xs={3}>
                ...
                <Grid item xs={1} />
                <Grid style={{color: "white", marginTop: "50px", paddingRight: "50px"}} item xs={4}>
                ...
                <Grid justifyContent="center" container spacing={10}style ={{marginTop: "50px", marginBottom: "100px"}}>
                    {/* <Grid item xs={1}/> */}
                <Grid item xs={3} />
                <Grid style={{color: "white", marginTop: "150px" }} item xs={3}>
                ...
                <Grid item xs={3}>
                <img src={virtual} alt="group training"style={{borderRadius:"8px"}} />
                </Grid>
                <Grid item xs={2}/>
