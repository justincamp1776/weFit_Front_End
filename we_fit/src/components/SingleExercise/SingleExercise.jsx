        ...
        <DialogContent>
          ...
          <Card className="dialog" style={{ width: "30rem" }}>
            ...
            <ListGroup variant="flush">
              <ListGroup.Item>
                Plane of Movement : {props.exercise.plane}
              </ListGroup.Item>
              <ListGroup.Item>
                Anatomical Symmetry : {props.exercise.num_of_limbs}
              </ListGroup.Item>
              <ListGroup.Item>
                Muscular Action : {props.exercise.push_pull}
              </ListGroup.Item>
              <ListGroup.Item>
                Primary Mover : {props.exercise.agonist}
              </ListGroup.Item>
              <ListGroup.Item>
                Stabilizers : {props.exercise.synergist}
              </ListGroup.Item>
